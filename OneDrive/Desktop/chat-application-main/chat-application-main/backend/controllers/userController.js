...
//       .cookie("token", token, {
//         maxAge: 1 * 24 * 60 * 60 * 1000, // 1 day
//         httpOnly: true,  // Security: Cookie cannot be accessed via JavaScript
//         secure: true, // Ensure cookies are sent over HTTPS in production
//         sameSite: "None",  // Allow cookies to be sent across domains (when deployed on different domains/subdomains)
//         path: "/",
//       })
//          .json({
//             _id: user._id,
