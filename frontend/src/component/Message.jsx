...
//           </time>
//   </div>
//   <div className={`chat-bubble ${authUser?._id === message?.senderId ? 'bg-white':'bg-red-900'}`} > <p className={`${authUser?._id === message?.senderId ? 'text-black':'text-white'}`}>{message?.message}</p></div>
